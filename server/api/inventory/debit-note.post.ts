// server/api/inventory/debit-note.post.ts
...
export default defineEventHandler(async (event) => {
  ...
  try {
    ...
    try {
      ...
      const ledgerResult = await createDebitNoteLedgerTransactionMongo(createdBill, user._id.toString(), user.firmId.toString());
