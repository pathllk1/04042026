...
/**
 * API endpoint for exporting expense reports to PDF
 *
 * Handles GET operations to generate PDF reports
 */
export default defineEventHandler(async (event) => {
  ...
  try {
    ...
    setResponseHeaders(event, {
      ...
      'Content-Disposition': `attachment; filename="${getReportFileName(reportType)}.pdf"`,
...
function generateSubsReport(expenses) {
  ...
  // We need to normalize the transactions so they display correctly in the PDF report
