<template>
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" :width="width" :height="height" :class="className">
    <defs>
      <linearGradient id="excelGradient" x1="6" x2="27" y1="24" y2="24" gradientUnits="userSpaceOnUse">
    ...
    <path fill="url(#excelGradient)" d="m27,42l-21-4V10l21-4v36Z"></path>
